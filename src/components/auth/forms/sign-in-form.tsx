...
export function SignInForm({
    ...
    let passwordSchema = passwordValidation?.minLength
    ...
    if (passwordValidation?.maxLength) {
        passwordSchema = passwordSchema.max(passwordValidation.maxLength, {
            message: localization.passwordTooLong
        })
    }
    if (passwordValidation?.regex) {
        passwordSchema = passwordSchema.regex(passwordValidation.regex, {
